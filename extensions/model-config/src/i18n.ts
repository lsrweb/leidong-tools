...
const zh: Translations = {
	...
	// API Key
	'auth.apiKeyRequiredDetail': '请先为该模型配置 API Key',
	...
	'auth.notConfigured': 'API Key 未配置，请打开"配置自定义模型"面板为该模型设置 API Key。',
	...
	// Extension
	'extension.activateFailed': '模型配置扩展激活失败，请运行 "雷动模型配置: 显示模型日志" 查看详情。',
	'extension.deactivateFailed': '模型配置扩展停用异常',
	'extension.welcomeFailed': '欢迎引导加载异常',
	'extension.openRequestDumpsFolderFailed':
		'打开请求 dump 目录失败，请运行 "雷动模型配置: 显示模型日志" 查看详情。',
};
...
const en: Translations = {
	...
	// API Key
	'auth.apiKeyRequiredDetail': 'Configure an API key for this model first',
	'auth.prompt':
	...
	'auth.notConfigured':
		'API key not configured. Open the "Configure Custom Models" panel to set one for this model.',
	...
	'vision.panel.title': 'Vision Proxy',
	'vision.panel.description':
		'Configure a vision-capable model to turn image attachments into text before the target model receives the request. The target model receives the description, not the original images.',
	...
	'extension.activateFailed':
		'Model config extension failed to activate. Run "LeiDong Models: Show Logs" for details.',
	'extension.deactivateFailed': 'Failed to prepare model provider for deactivate',
	'extension.welcomeFailed': 'Failed to show welcome prompt',
	'extension.openRequestDumpsFolderFailed':
		'Failed to open request dumps folder. Run "LeiDong Models: Show Logs" for details.',
};
