...
export const VISION_PROXY_CONFIG_KEY = 'leidong-models.visionProxy.config';
export const VISION_PROXY_SOURCE_KEY = 'leidong-models.visionProxy.source';
export const VISION_PROXY_API_KEY_SECRET = 'leidong-models.visionProxy.apiKey';
