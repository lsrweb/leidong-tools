...
const EXCLUDED_VISION_MODEL_VENDORS = new Set(['deepseek', 'claude-code', 'copilotcli', 'leidong-tools']);
...
export function getVisionPrompt(): string {
	const config = vscode.workspace.getConfiguration('leidong-models');
	return (
