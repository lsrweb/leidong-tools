...
export function registerCommands(context: vscode.ExtensionContext): void {
	context.subscriptions.push(
		vscode.commands.registerCommand('leidong-tools.copilot.showLogs', () => logger.show()),
		vscode.commands.registerCommand('leidong-tools.copilot.openRequestDumpsFolder', () =>
			openRequestDumpsFolder(context),
		),
		vscode.commands.registerCommand('leidong-tools.copilot.getDeepSeekApiKey', () =>
			vscode.env.openExternal(vscode.Uri.parse(EXTERNAL_URLS.deepseek.apiKeys)),
		),
		vscode.commands.registerCommand('leidong-tools.copilot.openSettings', () =>
			vscode.commands.executeCommand('workbench.action.openSettings', 'leidong-tools.copilot'),
		),
	);
}
