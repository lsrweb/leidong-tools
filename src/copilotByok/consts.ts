...
export const CONFIG_SECTION = 'leidong-tools.copilot';
...
export const MIMO_API_KEY_SECRET = 'leidong-tools.copilot.mimoApiKey';
export const MIMO_TOKEN_PLAN_API_KEY_SECRET = 'leidong-tools.copilot.mimoTokenPlanApiKey';
...
export const MODELS: ModelDefinition[] = [
	...
	},
	{
		...
		family: 'mimo',
		version: 'v2.5',
		detail: 'MiMo flagship model through the official OpenAI-compatible API',
	...
	},
	{
		...
		family: 'mimo',
		version: 'v2.5',
		detail: 'MiMo general-purpose model through the official OpenAI-compatible API',
		maxInputTokens: 1048576,
		maxOutputTokens: 65536,
		capabilities: { toolCalling: true, imageInput: true, thinking: false },
		requiresThinkingParam: false,
