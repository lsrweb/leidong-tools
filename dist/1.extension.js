...
/* harmony export */   doc: () => (/* reexport module object */ _doc_mjs__WEBPACK_IMPORTED_MODULE_9__),
...
/* harmony export */ });
/* harmony import */ var module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(217);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(218);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(219);
/* harmony import */ var process__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(220);
/* harmony import */ var assert__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(222);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(176);
/* harmony import */ var v8__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(223);
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(22);
/* harmony import */ var _doc_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(225);



const require = (0,module__WEBPACK_IMPORTED_MODULE_0__.createRequire)("file:///E:/unitools/node_modules/prettier/index.mjs");
const __filename = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)("file:///E:/unitools/node_modules/prettier/index.mjs");
...
__export(index_exports, {
  ...
  doc: () => _doc_mjs__WEBPACK_IMPORTED_MODULE_9__,
  format: () => format2,
...
var toPath = (urlOrPath) => isUrl(urlOrPath) ? url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath(urlOrPath) : urlOrPath;
var toAbsolutePath = (urlOrPath) => urlOrPath ? path__WEBPACK_IMPORTED_MODULE_2__.resolve(isUrl(urlOrPath) ? url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath(urlOrPath) : urlOrPath) : urlOrPath;
...
async function findInDirectory(nameOrNames, { typeCheck, cwd, allowSymlinks = true, filter: filter2 }) {
  const directory = toAbsolutePath(cwd) ?? process__WEBPACK_IMPORTED_MODULE_4__.cwd();
...
async function safeStat(path15, allowSymlinks = true) {
  try {
    return await (allowSymlinks ? fs_promises__WEBPACK_IMPORTED_MODULE_3__.stat : fs_promises__WEBPACK_IMPORTED_MODULE_3__.lstat)(path15);
  } catch {
  }
}
...
function* iterateDirectoryUp(from, to) {
  let directory = toAbsolutePath(from) ?? process__WEBPACK_IMPORTED_MODULE_4__.cwd();
  let stopDirectory = toAbsolutePath(to);
  if (stopDirectory) {
    const relation = path__WEBPACK_IMPORTED_MODULE_2__.relative(stopDirectory, directory);
    if (relation[0] === "." || relation === directory) {
      return;
    }
  }
  stopDirectory = stopDirectory ? directory.slice(0, stopDirectory.length) : path__WEBPACK_IMPORTED_MODULE_2__.parse(directory).root;
  while (directory !== stopDirectory) {
    yield directory;
    directory = path__WEBPACK_IMPORTED_MODULE_2__.dirname(directory);
  }
  yield stopDirectory;
}
...
async function findProjectRoot(startDirectory, options8) {
  ...
  return directory ? path__WEBPACK_IMPORTED_MODULE_2__.dirname(directory) : void 0;
}
...
async function readFile(file) {
  ...
  try {
    return await fs_promises__WEBPACK_IMPORTED_MODULE_3__.readFile(file, "utf8");
  } catch (error) {
...
async function importModuleDefault(file) {
  const module = await __webpack_require__(221)((0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(file).href);
...
async function loadYaml(file) {
  const content = await read_file_default(file);
  if (!parseYaml) {
    ({ __parsePrettierYamlConfig: parseYaml } = await __webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(__webpack_require__, 226)));
  }
  try {
...
codes.ERR_INVALID_ARG_TYPE = createError(
  ...
  (name, expected, actual) => {
    assert__WEBPACK_IMPORTED_MODULE_5__.ok(typeof name === "string", "'name' must be a string");
    ...
    for (const value of expected) {
      assert__WEBPACK_IMPORTED_MODULE_5__.ok(
        typeof value === "string",
...
codes.ERR_INVALID_PACKAGE_TARGET = createError(
  ...
  (packagePath, key2, target, isImport = false, base = void 0) => {
    ...
    if (key2 === ".") {
      assert__WEBPACK_IMPORTED_MODULE_5__.ok(isImport === false);
...
codes.ERR_INVALID_ARG_VALUE = createError(
  ...
  (name, value, reason = "is invalid") => {
    let inspected = (0,util__WEBPACK_IMPORTED_MODULE_8__.inspect)(value);
...
function isErrorStackTraceLimitWritable() {
  try {
    if (v8__WEBPACK_IMPORTED_MODULE_7__.startupSnapshot.isBuildingSnapshot()) {
      return false;
    }
  } catch {
  }
...
function getMessage(key2, parameters, self) {
  ...
  assert__WEBPACK_IMPORTED_MODULE_5__.ok(message !== void 0, "expected `message` to be found");
  ...
  return Reflect.apply(util__WEBPACK_IMPORTED_MODULE_8__.format, null, parameters);
}
function determineSpecificType(value) {
  ...
  if (typeof value === "object") {
    ...
    return `${(0,util__WEBPACK_IMPORTED_MODULE_8__.inspect)(value, { depth: -1 })}`;
  }
  let inspected = (0,util__WEBPACK_IMPORTED_MODULE_8__.inspect)(value, { colors: false });
...
function read2(jsonPath, { base, specifier }) {
  ...
  let string;
  try {
    string = fs__WEBPACK_IMPORTED_MODULE_6__.readFileSync(path__WEBPACK_IMPORTED_MODULE_2__.toNamespacedPath(jsonPath), "utf8");
  } catch (error) {
    const exception = (
      /** @type {ErrnoException} */
      error
...
function getFileProtocolModuleFormat(url3, _context, ignoreErrors) {
  ...
  const filepath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(url3);
...
function emitLegacyIndexDeprecation(url3, packageJsonUrl, base, main) {
  ...
  const urlPath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(url3.href);
  const packagePath = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(new URL(".", packageJsonUrl));
...
function tryStatSync(path15) {
  try {
    return (0,fs__WEBPACK_IMPORTED_MODULE_6__.statSync)(path15);
  } catch {
  }
}
function fileExists(url3) {
  const stats = (0,fs__WEBPACK_IMPORTED_MODULE_6__.statSync)(url3, { throwIfNoEntry: false });
...
function legacyMainResolve(packageJsonUrl, packageConfig, base) {
  ...
  throw new ERR_MODULE_NOT_FOUND(
    (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(new URL(".", packageJsonUrl)),
...
function finalizeResolution(resolved, base, preserveSymlinks) {
  ...
  if (!preserveSymlinks) {
    const real = (0,fs__WEBPACK_IMPORTED_MODULE_6__.realpathSync)(filePath);
...
function importNotDefined(specifier, packageJsonUrl, base) {
  return new ERR_PACKAGE_IMPORT_NOT_DEFINED(
    specifier,
    packageJsonUrl && (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(new URL(".", packageJsonUrl)),
    (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(base)
  );
}
...
function moduleResolve(specifier, base, conditions, preserveSymlinks) {
  ...
  assert__WEBPACK_IMPORTED_MODULE_5__.ok(resolved !== void 0, "expected to be defined");
...
function defaultResolve(specifier, context = {}) {
  ...
  assert__WEBPACK_IMPORTED_MODULE_5__.ok(parentURL !== void 0, "expected `parentURL` to be defined");
...
function importFromFile(specifier, parent) {
  ...
  return __webpack_require__(224)(url3);
}
...
function breakTies(tiesToBreak, options8) {
  ...
  for (indexOfFirstLeadingComment = tieCount; indexOfFirstLeadingComment > 0; --indexOfFirstLeadingComment) {
    ...
    (0,assert__WEBPACK_IMPORTED_MODULE_5__.strictEqual)(currentCommentPrecedingNode, precedingNode);
    (0,assert__WEBPACK_IMPORTED_MODULE_5__.strictEqual)(currentCommentFollowingNode, followingNode);
...
var {
  ...
  line: line2,
  lineSuffix
} = _doc_mjs__WEBPACK_IMPORTED_MODULE_9__.builders;
...
var create_print_pre_check_function_default =  true ? () => noop_default : 0;
...
var getFileBasename = (file) => {
  try {
    return path__WEBPACK_IMPORTED_MODULE_2__.basename(toPath(file));
  } catch {
    return "";
  }
};
...
var getLanguageByInterpreter =  false ? 0 : getLanguageByInterpreterNodejs;
function getLanguageByIsSupported(languages2, file) {
  ...
  if (isUrl(file)) {
    try {
      file = (0,url__WEBPACK_IMPORTED_MODULE_1__.fileURLToPath)(file);
    } catch {
      return;
    }
  }
...
} = _doc_mjs__WEBPACK_IMPORTED_MODULE_9__.utils;
...
function calculateRange(text, opts, ast) {
  ...
  (0,assert__WEBPACK_IMPORTED_MODULE_5__.ok)(end > start);
...
} = _doc_mjs__WEBPACK_IMPORTED_MODULE_9__.printer;
var BOM = "\uFEFF";
...
var estreePlugin = createParsersAndPrinters([
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(__webpack_require__, 227)),
...
var { parsers, printers } = createParsersAndPrinters([
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(__webpack_require__, 228)),
    parsers: ["acorn", "espree"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(__webpack_require__, 229)),
    parsers: [
      "__ng_action",
      "__ng_binding",
      "__ng_interpolation",
  ...
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(__webpack_require__, 230)),
    parsers: [
      "babel",
      "babel-flow",
      "babel-ts",
  ...
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 8).then(__webpack_require__.bind(__webpack_require__, 231)),
    parsers: ["flow"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 9).then(__webpack_require__.bind(__webpack_require__, 232)),
    parsers: ["glimmer"],
    printers: ["glimmer"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 10).then(__webpack_require__.bind(__webpack_require__, 233)),
    parsers: ["graphql"],
    printers: ["graphql"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 11).then(__webpack_require__.bind(__webpack_require__, 234)),
    parsers: ["html", "angular", "vue", "lwc", "mjml"],
    printers: ["html"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 12).then(__webpack_require__.bind(__webpack_require__, 235)),
    parsers: ["markdown", "mdx", "remark"],
    printers: ["mdast"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 13).then(__webpack_require__.bind(__webpack_require__, 236)),
    parsers: ["meriyah"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 14).then(__webpack_require__.bind(__webpack_require__, 237)),
    parsers: ["css", "less", "scss"],
    printers: ["postcss"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 15).then(__webpack_require__.bind(__webpack_require__, 238)),
    parsers: ["typescript"]
  },
  {
    importPlugin: () => __webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(__webpack_require__, 226)),
    parsers: ["yaml"],
    printers: ["yaml"]
  }
]);
...
async function importPlugin(name, cwd) {
  if (isUrl(name)) {
    return __webpack_require__(224)(name);
  }
  if (path__WEBPACK_IMPORTED_MODULE_2__.isAbsolute(name)) {
    return __webpack_require__(224)((0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(name).href);
  }
  try {
    return await __webpack_require__(224)((0,url__WEBPACK_IMPORTED_MODULE_1__.pathToFileURL)(path__WEBPACK_IMPORTED_MODULE_2__.resolve(name)).href);
  } catch {
...
var slash = path__WEBPACK_IMPORTED_MODULE_2__.sep === "\\" ? (filePath) => method_replace_all_default(
  /* OPTIONAL_OBJECT: false */
  0,
  filePath,
  "\\",
...
/* harmony export */   "default": () => (/* binding */ public_exports),
...
var assertAlignType =  true ? noop_default : 0;
